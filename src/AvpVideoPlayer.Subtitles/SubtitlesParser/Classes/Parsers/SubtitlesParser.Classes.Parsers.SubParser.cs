...
#pragma warning restore CS8603 // Possible null reference return.
    ...
    {
        Dictionary<SubtitlesFormat, ISubtitlesParser> subFormatDictionary = subFormat != null ? _subFormatToParser.OrderBy((dic) => Math.Abs(string.Compare(dic.Key.Name, subFormat.Name, StringComparison.Ordinal))).ToDictionary((entry) => entry.Key, (entry) => entry.Value) : _subFormatToParser;
