...
public class LibraryViewModel : EventBasedViewModel
{
    ...
    public LibraryViewModel(IUserConfiguration userSettingsService, IEventHub eventHub, SearchBoxViewModel searchBoxViewModel, FolderDropDownViewModel folderDropDownViewModel, FileListViewModel fileListViewModel) : base(eventHub)
    {
    ...
    private void OnDeleteCurrentVideo(DeleteCurrentVideoEvent obj)
    {
        ...
        var result = DialogResult.Cancel; // _dialogService.Show($@"Are you sure you want to delete ""{filename}""?", "Confirm delete", true, DialogTypes.Warning);
