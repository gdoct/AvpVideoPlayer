...
public class VideoPlayerViewModel : EventBasedViewModel
{
    ...
    public VideoPlayerViewModel(IEventHub eventHub, PlayerControlsViewModel playerControlsViewModel, IViewRegistrationService viewRegistrationService, IUserConfiguration userConfiguration) : base(eventHub)
    {
        ...
        _timer = new DispatcherTimer() { Interval = DEFAULT_INTERVAL };
        ...
        OnMediaOpenedCommand = new RelayCommand(OnMediaOpened);
        //OnPreviewDragOver = new RelayCommand(PerformOnPreviewDragOver);
        //OnDrop = new RelayCommand(PerformOnDrop);
    ...
    public ObservableCollection<object> AvailableSubs { get; } = new ObservableCollection<object>();
    ...
    private void OnAvailableSubtitlesChanged()
    {
        ...
        OnAvailableSubtitlesChangedImpl();
    }
    private void OnAvailableSubtitlesChangedImpl()
    {
        //var __ = SubtitleService.AvailableSubtitles.ToList();
        //AvailableSubs.Clear();
        //var _ = SubtitleService.CurrentSubtitleInfo;
        //if (subs.Any())
        //{
    ...
    {
        if (_isPlayingFullscreen != e.Data)
    ...
    private void OnMediaOpened(object _)
    {
